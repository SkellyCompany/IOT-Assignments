...
function PageMetadata(props: IProps) {
  ...
  const pageMetadata = new Page({
    ...
    name: props.pageMetadata?.name ?? "Portal",
    description: props.pageMetadata?.description ?? "Portal",
    metaTitle: props.pageMetadata?.metaTitle ?? "Portal",
    metaDescription: props.pageMetadata?.metaDescription ?? "Portal",
    metaKeyword: props.pageMetadata?.metaKeyword ?? "Portal",
